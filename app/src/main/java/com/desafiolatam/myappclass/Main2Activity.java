...
import android.widget.Toast;public class Main2Activity extends AppCompatActivity {
    @Override
...
protected void onCreate(Bundle savedInstanceState) {
    ...
    setSupportActionBar(toolbar);        FloatingActionButton fab = findViewById(R.id.fab);
